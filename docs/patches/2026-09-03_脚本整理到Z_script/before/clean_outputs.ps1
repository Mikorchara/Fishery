...
#
# 用法（PowerShell）：
#   .\clean_outputs.ps1                     # 清理日志/截图/录像/基准/__pycache__
#   .\clean_outputs.ps1 -All                # 额外删除 data.db（传感器历史）
#   .\clean_outputs.ps1 -KeepRecordings 3   # 录像保留最新 3 个
#   .\clean_outputs.ps1 -WhatIf             # 预览模式：只显示将删除的内容，不执行
#
# 注意：
